...
const dictionaries: Record<Language, Translations> = {
  en: {
    ...
    commissionsEnabled: 'Enable Commissions',
    commissionPercent: 'Fee %',
    commissionMin: 'Min Fee ($)',
    commissionMax: 'Max Fee ($)',
    ltvBasis: 'LTV Basis',
  ...
  fr: {
    ...
    // Commissions
    tradingCommissions: 'Commissions de Courtage',
    commissionsEnabled: 'Activer les commissions',
    commissionPercent: 'Frais %',
    commissionMin: 'Frais min ($)',
    commissionMax: 'Frais max ($)',
  ...
  'zh-CN': {
    ...
    // Commissions
    tradingCommissions: '券商交易佣金',
    commissionsEnabled: '开启交易费用',
